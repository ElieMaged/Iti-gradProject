    ...
    <form @submit="handleSubmit" class="flex flex-col">
      ...
      <div class="mb-3">
        ...
        <textarea 
          ...
          rows="4"
          :class="[
            'w-full bg-gray-50 border  text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-150 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500',
