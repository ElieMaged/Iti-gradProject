    ...
    <div class="flex">
      ...
      <aside class="w-64 side-bar-color min-h-screen p-6">
        <nav class="space-y-4">
          ...
          <router-link :to="getRoute('pending-bookings')" :class="[ 'flex items-center space-x-3 py-2 px-3 rounded-lg transition-colors', activeTab === 'booking' ? 'bg-purple-200 text-purple-700 font-medium' : 'text-gray-700 hover:text-purple-700']" @click="activeTab = 'booking'">
