...
const messages = {
  en: {
    ...
    totalDeductionExceedsCredits:
      "Total deduction (including fees) exceeds available credits",
    // Footer
    footerQuickInfo:
    ...
    previousServicesDescription:
      "Review your past bookings and service history",
    loadingHistory: "Loading booking history...",
    noBookingHistory: "No Booking History",
    noBookingHistoryDescription:
      "You haven't completed any bookings yet. Start by booking a service!",
    ...
    userDeletedSuccess:
      "User {name} has been deleted successfully from the database!",
    ...
    confirmDeleteTechnician:
      "Are you sure you want to delete {name}? This action cannot be undone.",
    technicianDeletedSuccess:
      "Technician {name} has been deleted successfully from the database!",
    ...
    reviewBookingNotify:
      "We will review your booking and notify you via email.",
    confirmationEmailInstructions:
      "You will receive an email confirmation once the technician approves your request. In case of rejection, you'll be notified with further instructions.",
    ...
    carpentryServiceTitle: "Carpentry",
    carpentryServiceDesc:
      "Expert woodwork and furniture services with quality craftsmanship",
    electricityServiceTitle: "Electrical",
    electricityServiceDesc:
      "Safe and reliable electrical services for homes and businesses",
    acTechniciansServiceTitle: "AC Technicians",
    acTechniciansServiceDesc:
      "Professional air conditioning installation, repair, and maintenance",
    applianceRepairServiceTitle: "Appliance Repair",
    applianceRepairServiceDesc:
      "Fast and efficient repair services for all household appliances",
    wallFinishingServiceTitle: "Wall Finishing",
    wallFinishingServiceDesc:
      "High-quality painting and finishing services for walls and ceilings",
  ...
  ar: {
    ...
    userDescription:
      "انضم إلينا الآن لحجز فنيين موثوقين بالقرب منك. سنربطك بالمحترفين في بضع نقرات فقط.",
    technicianDescription:
      "سجل لتقديم خدماتك والوصول إلى المزيد من العملاء في منطقتك. أنشئ ملفك الشخصي وابدأ في استقبال الحجوزات.",
    ...
    totalDeductionExceedsCredits:
      "إجمالي الخصم (بما في ذلك الرسوم) يتجاوز الرصيد المتاح",
    // Footer
    footerQuickInfo:
