...
const routes = [
  ...
  {
    path: "/technician-booking-upcoming",
    component: TechnicianBookingUpcoming,
  },
  {
    path: "/technician-booking-completed",
    component: TechnicianBookingCompleted,
  },
  ...
  {
    path: "/admin-pending-tech/pending-technician-profile/:id",
    component: AdminPendingTechProfile,
  },
